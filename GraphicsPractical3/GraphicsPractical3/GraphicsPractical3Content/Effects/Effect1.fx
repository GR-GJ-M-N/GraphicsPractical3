...
float4 E6PixelShader(float2 TextureCoord : TEXCOORD0) : COLOR0
{
	 ...
	 //Add the color of the nearby pixels, defined by the offsets, with each certain weights to keep the color in the right range annd give a nice Gaussian result
	 for (int i = 0; i < 7; ++i)
